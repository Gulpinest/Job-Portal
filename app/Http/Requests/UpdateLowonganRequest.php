...
class UpdateLowonganRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'lokasi_kantor' => 'sometimes|required|string|max:255',
            'gaji' => 'sometimes|required|numeric|min:0',
            'keterampilan' => 'sometimes|required|string',
            'tipe_kerja' => 'sometimes|required|in:Full-time,Part-time,Remote,Freelance',
