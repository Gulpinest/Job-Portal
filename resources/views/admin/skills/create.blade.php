        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form method="POST" action="{{ route('admin.skills.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="nama_skill" name="nama_skill" value="{{ old('nama_skill') }}" 
                           ...
                           placeholder="contoh: Laravel, React, PHP">
                    @error('nama_skill')
                ...
                <div class="mb-6">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="4"
                              ...
                              placeholder="Deskripsi skill (opsional)">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
