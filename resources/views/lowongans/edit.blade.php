                    ...
                    <form action="{{ route('lowongans.update', $lowongan->id_lowongan) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="5"
                                class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm">{{ old('deskripsi', $lowongan->deskripsi) }}</textarea>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <select name="status" id="status"
                                class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm">
                                <option value="Open" {{ $lowongan->status == 'Open' ? 'selected' : '' }}>Open</option>
                                <option value="Closed" {{ $lowongan->status == 'Closed' ? 'selected' : '' }}>Closed
                                </option>
                            </select>
                        </div>
