                ...
                @if (Auth::user()->company && !Auth::user()->company->is_verified)
                    <div class="mb-6 p-5 bg-amber-50 border-l-4 border-amber-500 rounded-r-lg shadow-md">
                        <div class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mt-0.5 mr-3 flex-shrink-0" fill="currentColor"
                                viewBox="0 0 20 20">
                            ...
                            <div>
                                ...
                                <p class="text-amber-700 mt-1">Perusahaan Anda belum disetujui oleh administrator. Anda
                                    tidak dapat membuat lowongan pekerjaan sampai akun Anda diverifikasi.</p>
                                <p class="text-sm text-amber-600 mt-2">Status: <span class="font-semibold">Menunggu
                                        Persetujuan Admin</span></p>
                            </div>
                        </div>
                    </div>
                @endif
