                    ...
                    <form action="{{ route('resumes.update', $resume->id_resume) }}" method="POST"
                        ...
                        <div>
                            <label for="nama_resume"
                                class="block font-medium text-sm text-gray-700 dark:text-gray-300">{{ __('Judul Resume') }}</label>
                        ...
                        <div class="mt-4">
                            <label for="file_resume"
                                class="block font-medium text-sm text-gray-700 dark:text-gray-300">{{ __('Upload File Baru (Opsional)') }}</label>
                            <input id="file_resume" name="file_resume" type="file"
                                class="block mt-1 w-full text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" />
                            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                File saat ini: <a href="{{ Storage::url($resume->file_resume) }}" target="_blank"
                                    class="text-indigo-600 dark:text-indigo-400 hover:underline">Lihat File</a><br>
                                <span class="text-red-500">Kosongkan jika tidak ingin mengubah file.</span>
                            </p>
                        </div>
